...
router.post('/process-pdf', upload.single('pdf'), async (req, res) => {
  try {
    ...
    // Por ahora NO enviar a N8N, solo procesar y devolver
    console.log('⚠️ N8N deshabilitado temporalmente - solo mostrando datos en consola');

    // Respuesta exitosa sin N8N
    return res.json({
      success: true,
      message: 'PDF procesado exitosamente (N8N deshabilitado)',
      data: {
